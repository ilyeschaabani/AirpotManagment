...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        public static Plane BoingPlane = new Plane { PlaneType = PlaneType.Boing, Capacity = 150, ManufactureDate = new DateTime(2015, 02, 03),AirLineLogo="tunisair" };
        public static Plane Airbusplane = new Plane { PlaneType = PlaneType.Airbus, Capacity = 250, ManufactureDate = new DateTime(2020, 11, 11),AirLineLogo = "tunisair" };
        // Staffs
        ...
        public static Flight flight1 = new Flight
        {
            ...
            Departure = new DateTime(2022, 01, 01, 17, 10, 10)
